                        ...
                        <div class="col-md-12">
                          ...
                          <?php  if($admin_data->user_status == '0') { ?>
                                  <a type="button" data-bs-toggle="modal" data-bs-target="#smallModel" 
                                        class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary text-right"  style="text-transform: capitalize;">Add Announcement</a>
                                        <?php  } ?>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Add Announcement
                    </h4>
...
$(document).on('click','#save_nav',function(){
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Admin/delete_announcement') ?>',
    data: {id:id},
    success: function (response) {
